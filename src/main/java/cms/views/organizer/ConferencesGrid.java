...
public class ConferencesGrid extends Div {
        ...
        grid.addComponentColumn(conference -> {
            ...
            deleteButton.addClickListener(event -> {
                try {
                    ...
                    refreshGrid();
                    // Refresh the page after 3 seconds, using set time out
    ...
    //
    // // Validate the input
    // if (conference.getName().isEmpty() || conference.getStartDate() == null ||
    // conference.getEndDate() == null || conference.getDeadline() == null ||
    // conference.getConferenceCode().isEmpty() ||
    // conference.getOrganizerName().isEmpty() ||
    ...
    // }
    //
    // Conference newConference = new Conference(conference.getName(),
    // conference.getStartDate(), conference.getEndDate(), conference.getDeadline(),
    // conference.getConferenceCode(), organizerId, venueId);
    //
    ...
    // editDialog.add(nameField, startDateField, endDateField, deadlineField,
    // codeField, organizerField, venueSelect, confirmButton);
    //
    // // Open the dialog
    // editDialog.open();
    //
    ...
    // }
    //
    // private static Select<String> createVenueSelect(Conference conference) throws
    // SQLException {
    // DBConnector dataService = new DBConnector();
    //
